...
mamba.exe install "python=3.10" pip mamba conda-build conda=24.3.0 conda-build=24.7.1 conda-forge-ci-setup=4 python=3.10 -c conda-forge --strict-channel-priority --yes
if !errorlevel! neq 0 exit /b !errorlevel!
