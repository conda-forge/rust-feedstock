...
wget https://static.rust-lang.org/dist/$ver/rust-nightly-aarch64-apple-darwin.tar.gz
...
echo "  sha256: $(sha256sum rust-nightly-aarch64-apple-darwin.tar.gz | cut -b -64)  # [osx and arm64]"
